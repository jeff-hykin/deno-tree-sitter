...
```js
import { Parser, parserFromWasm } from "https://deno.land/x/deno_tree_sitter@0.2.2.4/main.js"
...
```js
import { parserFromWasm, flatNodeList } from "https://deno.land/x/deno_tree_sitter@0.2.2.4/main.js"
