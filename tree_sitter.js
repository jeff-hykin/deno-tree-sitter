...
var Z = ((e) => typeof require2 < "u" ? require2 : typeof Proxy < "u" ? new Proxy(e, { get: (t, _) => (typeof require2 < "u" ? require2 : t)[_] }) : e)(function(e) {
...
var te = (e, t) => {
  for (var _ in t)
    L(e, _, { get: t[_], enumerable: true });
};
var D = (e, t, _, s) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let r of K(t))
      !Q.call(e, r) && r !== _ && L(e, r, { get: () => t[r], enumerable: !(s = X(t, r)) || s.enumerable });
  return e;
};
var P = (e, t, _) => (D(e, t, "default"), _ && D(_, t, "default"));
var $ = (e, t, _) => (_ = e != null ? Y(J(e)) : {}, D(t || !e || !e.__esModule ? L(_, "default", { value: e, enumerable: true }) : _, e));
var q = ee((exports, module) => {
      ...
      static init(moduleOptions) {
        return initPromise || (Module = Object.assign({}, Module, moduleOptions), initPromise = new Promise((resolveInitPromise) => {
          var moduleOverrides = Object.assign({}, Module), arguments_ = [], thisProgram = "./this.program", quit_ = (e, t) => {
            throw t;
          }, ENVIRONMENT_IS_WEB = typeof window == "object", ENVIRONMENT_IS_WORKER = typeof importScripts == "function", ENVIRONMENT_IS_NODE = typeof __Process$ == "object" && typeof __Process$.versions == "object" && typeof __Process$.versions.node == "string", scriptDirectory = "", read_, readAsync, readBinary;
          function locateFile(e) {
            return Module.locateFile ? Module.locateFile(e, scriptDirectory) : scriptDirectory + e;
          }
          if (ENVIRONMENT_IS_NODE) {
            var fs = Z("fs"), nodePath = Z("path");
            scriptDirectory = ENVIRONMENT_IS_WORKER ? nodePath.dirname(scriptDirectory) + "/" : "/_virtual/esm.sh/v135/web-tree-sitter@0.22.5/denonext/", read_ = (e, t) => (e = isFileURI(e) ? new URL(e) : nodePath.normalize(e), fs.readFileSync(e, t ? void 0 : "utf8")), readBinary = (e) => {
              var t = read_(e, true);
              return t.buffer || (t = new Uint8Array(t)), t;
            }, readAsync = (e, t, _, s = true) => {
              e = isFileURI(e) ? new URL(e) : nodePath.normalize(e), fs.readFile(e, s ? void 0 : "utf8", (r, a) => {
                r ? _(r) : t(s ? a.buffer : a);
              });
            }, !Module.thisProgram && __Process$.argv.length > 1 && (thisProgram = __Process$.argv[1].replace(/\\/g, "/")), arguments_ = __Process$.argv.slice(2), typeof module < "u" && (module.exports = Module), quit_ = (e, t) => {
              throw __Process$.exitCode = e, t;
            };
          } else
            (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && (ENVIRONMENT_IS_WORKER ? scriptDirectory = self.location.href : document !== void 0 && document.currentScript && (scriptDirectory = document.currentScript.src), scriptDirectory = scriptDirectory.startsWith("blob:") ? "" : scriptDirectory.substr(0, scriptDirectory.replace(/[?#].*/, "").lastIndexOf("/") + 1), read_ = (e) => {
          ...
          function instantiateArrayBuffer(e, t, _) {
            return Promise.resolve(uint8ArrayOfWasmTreeSitter).then((s) => WebAssembly.instantiate(s, t)).then(_, (s) => {
              err(`failed to asynchronously prepare wasm: ${s}`), abort(s);
            });
          }
          function instantiateAsync(e, t, _, s) {
            return e || typeof WebAssembly.instantiateStreaming != "function" || isDataURI(t) || isFileURI(t) || ENVIRONMENT_IS_NODE || typeof fetch != "function" ? instantiateArrayBuffer(t, _, s) : fetch(t, { credentials: "same-origin" }).then((r) => WebAssembly.instantiateStreaming(r, _).then(s, function(a) {
          ...
          function createWasm() {
            ...
            return instantiateAsync(wasmBinary, wasmBinaryFile, e, function(_) {
          ...
          var GOT = {}, currentModuleWeakSymbols = /* @__PURE__ */ new Set([]), GOTHandler = { get(e, t) {
            ...
            for (; e.length > 0; )
              e.shift()(Module);
          }, UTF8Decoder = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, UTF8ArrayToString = (e, t, _) => {
            ...
            for (var a = ""; t < r; ) {
              ...
              if (128 & o) {
                ...
                if ((224 & o) != 192) {
                  var u = 63 & e[t++];
                  if ((o = (240 & o) == 224 ? (15 & o) << 12 | n << 6 | u : (7 & o) << 18 | n << 12 | u << 6 | 63 & e[t++]) < 65536)
            ...
            if (o == "dylink") {
              ...
              for (a(o !== "dylink.0"); t < _; ) {
                ...
                if (p === 1)
                  ...
                  for (d = s(); d--; )
                    r(), b = r(), (3 & s()) == 1 && m.weakImports.add(b);
                else
                  t += I;
              }
            return m;
          ...
          function loadDynamicLibrary(e, t = { global: true, nodelete: true }, _, s) {
            ...
            function a() {
              if (s) {
                var u = HEAPU32[s + 28 >> 2], m = HEAPU32[s + 32 >> 2];
                if (u && m) {
          ...
          let C = Module, INTERNAL = {}, SIZE_OF_INT = 4, SIZE_OF_CURSOR = 4 * SIZE_OF_INT, SIZE_OF_NODE = 5 * SIZE_OF_INT, SIZE_OF_POINT = 2 * SIZE_OF_INT, SIZE_OF_RANGE = 2 * SIZE_OF_INT + 2 * SIZE_OF_POINT, ZERO_POINT = { row: 0, column: 0 }, QUERY_WORD_REGEX = /[\w-.]*/g, PREDICATE_STEP_TYPE_CAPTURE = 1, PREDICATE_STEP_TYPE_STRING = 2, LANGUAGE_FUNCTION_REGEX = /^_?tree_sitter_\w+/, VERSION, MIN_COMPATIBLE_VERSION, TRANSFER_BUFFER, currentParseCallback, currentLogCallback;
          class ParserImpl {
            static init() {
            ...
            setLanguage(t) {
              ...
              if (t) {
                  ...
                  throw new Error("Argument must be a Language");
                {
                  ...
                  if (s < MIN_COMPATIBLE_VERSION || VERSION < s)
                    throw new Error(`Incompatible language version ${s}. Compatibility range ${MIN_COMPATIBLE_VERSION} through ${VERSION}.`);
                }
              } else
                _ = 0, t = null;
            ...
            parse(t, _, s) {
              if (typeof t == "string")
                currentParseCallback = (u, m) => t.slice(u);
              else {
              ...
              if (s?.includedRanges) {
                ...
                let u = a;
                for (let m = 0; m < r; m++)
                  marshalRange(u, s.includedRanges[m]), u += SIZE_OF_RANGE;
              }
            ...
            getIncludedRanges() {
              ...
              let t = getValue(TRANSFER_BUFFER, "i32"), _ = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), s = new Array(t);
              if (t > 0) {
                let r = _;
                for (let a = 0; a < t; a++)
                  s[a] = unmarshalRange(r), r += SIZE_OF_RANGE;
                C._free(_);
              }
              return s;
            }
          ...
          class Tree {
            ...
            getChangedRanges(t) {
              ...
              let _ = getValue(TRANSFER_BUFFER, "i32"), s = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), r = new Array(_);
              if (_ > 0) {
                let a = s;
                for (let o = 0; o < _; o++)
                  r[o] = unmarshalRange(a), a += SIZE_OF_RANGE;
                C._free(s);
              }
              return r;
            }
          ...
          class Node {
            ...
            childrenForFieldId(t) {
              ...
              if (_ > 0) {
                let a = s;
                for (let o = 0; o < _; o++)
                  r[o] = unmarshalNode(this.tree, a), a += SIZE_OF_NODE;
                C._free(s);
              }
              return r;
            }
            ...
            get children() {
              if (!this._children) {
                ...
                let t = getValue(TRANSFER_BUFFER, "i32"), _ = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32");
                if (this._children = new Array(t), t > 0) {
                  let s = _;
                  for (let r = 0; r < t; r++)
                    this._children[r] = unmarshalNode(this.tree, s), s += SIZE_OF_NODE;
                  C._free(_);
                }
              }
            ...
            get namedChildren() {
              if (!this._namedChildren) {
                ...
                if (this._namedChildren = new Array(t), t > 0) {
                  let s = _;
                  for (let r = 0; r < t; r++)
                    this._namedChildren[r] = unmarshalNode(this.tree, s), s += SIZE_OF_NODE;
                  C._free(_);
                }
              }
            ...
            descendantsOfType(t, _, s) {
              ...
              for (let w = 0, c = a.length; w < c; w++)
                t.includes(a[w]) && r.push(w);
              let o = C._malloc(SIZE_OF_INT * r.length);
              for (let w = 0, c = r.length; w < c; w++)
                setValue(o + w * SIZE_OF_INT, r[w], "i32");
              marshalNode(this), C._ts_node_descendants_of_type_wasm(this.tree[0], o, r.length, _.row, _.column, s.row, s.column);
              let n = getValue(TRANSFER_BUFFER, "i32"), u = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), m = new Array(n);
              if (n > 0) {
                let w = u;
                for (let c = 0; c < n; c++)
                  m[c] = unmarshalNode(this.tree, w), w += SIZE_OF_NODE;
              }
          ...
          class TreeCursor {
            ...
            get nodeText() {
              ...
              let t = C._ts_tree_cursor_start_index_wasm(this.tree[0]), _ = C._ts_tree_cursor_end_index_wasm(this.tree[0]);
          ...
          class Language {
            constructor(t, _) {
              ...
              for (let s = 0, r = this.types.length; s < r; s++)
            ...
            idForNodeType(t, _) {
              let s = lengthBytesUTF8(t), r = C._malloc(s + 1);
            ...
            query(t) {
              let _ = lengthBytesUTF8(t), s = C._malloc(_ + 1);
...
`)[0], g, M = l.match(QUERY_WORD_REGEX)[0];
              ...
              let a = C._ts_query_string_count(r), o = C._ts_query_capture_count(r), n = C._ts_query_pattern_count(r), u = new Array(o), m = new Array(a);
              for (let d = 0; d < o; d++) {
                let b = C._ts_query_capture_name_for_id(r, d, TRANSFER_BUFFER), h = getValue(TRANSFER_BUFFER, "i32");
                u[d] = UTF8ToString(b, h);
              }
              for (let d = 0; d < a; d++) {
                let b = C._ts_query_string_value_for_id(r, d, TRANSFER_BUFFER), h = getValue(TRANSFER_BUFFER, "i32");
                m[d] = UTF8ToString(b, h);
              }
              let w = new Array(n), c = new Array(n), f = new Array(n), p = new Array(n), I = new Array(n);
              for (let d = 0; d < n; d++) {
                let b = C._ts_query_predicates_for_pattern(r, d, TRANSFER_BUFFER), h = getValue(TRANSFER_BUFFER, "i32");
                p[d] = [], I[d] = [];
                let l = [], g = b;
                for (let M = 0; M < h; M++) {
                  ...
                  if (g += SIZE_OF_INT, U === PREDICATE_STEP_TYPE_CAPTURE)
                    l.push({ type: "capture", name: u[W] });
                  else if (U === PREDICATE_STEP_TYPE_STRING)
                    l.push({ type: "string", value: m[W] });
                  else if (l.length > 0) {
                    if (l[0].type !== "string")
                      throw new Error("Predicates must begin with a literal value");
                    let T = l[0].value, v, R = true, k = true;
                    switch (T) {
                      case "any-not-eq?":
                      case "not-eq?":
                        R = false;
                      ...
                      case "eq?":
                        ...
                        if (k = !T.startsWith("any-"), l[2].type === "capture") {
                          ...
                          I[d].push((S) => {
                            let E = [], N = [];
                            for (let F of S)
                              F.name === y && E.push(F.node), F.name === x && N.push(F.node);
                            let B = (F, O, z) => z ? F.text === O.text : F.text !== O.text;
                            return k ? E.every((F) => N.some((O) => B(F, O, R))) : E.some((F) => N.some((O) => B(F, O, R)));
                          });
                        } else {
                          v = l[1].name;
                          let y = l[2].value, x = (E) => E.text === y, S = (E) => E.text !== y;
                          I[d].push((E) => {
                            let N = [];
                            for (let F of E)
                              F.name === v && N.push(F.node);
                            let B = R ? x : S;
            ...
            static load(t) {
              ...
              if (t instanceof Uint8Array)
                ...
                if (typeof __Process$ < "u" && __Process$.versions && __Process$.versions.node) {
                  ...
                  _ = fetch(s).then((r) => r.arrayBuffer().then((a) => {
                    if (r.ok)
...
${o}`);
              ...
              return _.then((s) => loadWebAssemblyModule(s, { loadAsync: true })).then((s) => {
                let r = Object.keys(s), a = r.find((n) => LANGUAGE_FUNCTION_REGEX.test(n) && !n.includes("external_scanner_"));
...
${JSON.stringify(r, null, 2)}`);
          ...
          class Query {
            ...
            matches(t, { startPosition: _ = ZERO_POINT, endPosition: s = ZERO_POINT, startIndex: r = 0, endIndex: a = 0, matchLimit: o = 4294967295, maxStartDepth: n = 4294967295 } = {}) {
              ...
              let u = getValue(TRANSFER_BUFFER, "i32"), m = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), w = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, "i32"), c = new Array(u);
            ...
            *iterMatches(t, startPosition=null, endPosition=null, options) {
            ...
            captures(t, { startPosition: _ = ZERO_POINT, endPosition: s = ZERO_POINT, startIndex: r = 0, endIndex: a = 0, matchLimit: o = 4294967295, maxStartDepth: n = 4294967295 } = {}) {
              ...
              let u = getValue(TRANSFER_BUFFER, "i32"), m = getValue(TRANSFER_BUFFER + SIZE_OF_INT, "i32"), w = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, "i32"), c = [];
              this.exceededMatchLimit = !!w;
              let f = [], p = m;
              for (let I = 0; I < u; I++) {
                let d = getValue(p, "i32");
                ...
                if (p += SIZE_OF_INT, f.length = b, p = unmarshalCaptures(this, t.tree, p, f), this.textPredicates[d].every((l) => l(f))) {
                  let l = f[h], g = this.setProperties[d];
                  g && (l.setProperties = g);
          ...
          function getText(e, t, _) {
            let s = _ - t, r = e.textCallback(t, null, _);
            for (t += r.length; t < _; ) {
          ...
          function unmarshalCaptures(e, t, _, s) {
            for (let r = 0, a = s.length; r < a; r++) {
              let o = getValue(_, "i32"), n = unmarshalNode(t, _ += SIZE_OF_INT);
          ...
          function unmarshalNode(e, t = TRANSFER_BUFFER) {
            ...
            if (_ === 0)
              return null;
            let s = getValue(t += SIZE_OF_INT, "i32"), r = getValue(t += SIZE_OF_INT, "i32"), a = getValue(t += SIZE_OF_INT, "i32"), o = getValue(t += SIZE_OF_INT, "i32"), n = new Node(INTERNAL, e);
